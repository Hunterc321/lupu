...
class ResEco extends StatefulWidget {
  @override
  _ResEcoState createState() => _ResEcoState();
}
...
Future<String> getData() async {
  var response = await http.get(Uri.encodeFull("http://10.0.2.2:3000/api/committees?title=ECOSOC"),

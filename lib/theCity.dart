...
import 'package:flutter_lupu2/theCitySchoolMap/schoolMap.dart';
...
_launchURLCity() async {
  const url =
      'https://www.google.com/maps?client=firefox-b-d&q=Iasi+map&um=1&ie=UTF-8&sa=X&ved=0ahUKEwioy8_ZhYzlAhXGGuwKHR5XA10Q_AUIESgB';
  if (await canLaunch(url)) {
    await launch(url);
  } else {
    throw 'Could not launch $url';
